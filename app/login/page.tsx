...
export default function LoginPage() {
    ...
    return (
        <div className="min-h-screen bg-linear-to-br from-slate-900 via-slate-800 to-slate-950 flex items-start justify-center p-4 pt-16">
                    ...
                    <CardContent className="space-y-6">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="text-center space-y-3">
                                ...
                                <Link 
                                    href="#" 
                                    className="text-sm text-slate-400 hover:text-slate-300 transition-colors block"
                                >
