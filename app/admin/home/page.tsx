...
export default function AdminHomePage() {
    ...
    const renderSection = useCallback(
        (sectionId: string, content: () => JSX.Element) => (activeSection === sectionId ? content() : null),
        [activeSection],
    );
                    ...
                    {ADMIN_SECTION_LINKS.map((section) => {
                        ...
                        return (
                            <Button
                                ...
                                className={`group flex h-full flex-col items-start gap-3 rounded-2xl border px-5 py-4 text-left text-slate-200 transition-all ${
                                    isActive
                            ...
                            >
                                <span className={`flex h-10 w-10 items-center justify-center rounded-xl border ${
                                    isActive ? 'border-white/30 bg-white/15 text-white' : 'border-white/15 bg-white/10 text-slate-100'
                                ...
                                <span className={`inline-flex items-center gap-2 text-[11px] font-semibold uppercase tracking-[0.35em] transition-colors ${
